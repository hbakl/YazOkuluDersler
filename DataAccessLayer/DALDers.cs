    ...
    public class DALDers
    {
        public static List<EntityDers> DersListesi()
        {
            ...
            while (dr.Read())
            {
                ...
                //alttaki kısımda soldaki değişkenler entity frameworkte tanımlanan değişkenler iken, sağdaki datareader içindeki kısımlar veri tabanındaki sütun isimleridir.
